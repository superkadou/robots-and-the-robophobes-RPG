...
* **Sous la forme de la Viande :** Athlétisme, encaissement des traumatismes, vitesse de réaction, sang-froid physique.
* **Sous la forme du Chrome :** Servomoteurs articulés, blindage bionique, optiques de visée, surcadencement moteur.
...
* **Sous la forme de l'Esprit :** Déduction logique, concentration, érudition, analyse comportementale brute.
* **Sous la forme du Software :** Payloads informatiques, algorithmes d'analyse, contre-mesures numériques, systèmes d'exploitation tactiques.
...
* **Sous la forme de l'Âme :** Volonté de fer, instinct, charisme naturel, résistance au choc psychologique.
* **Sous la forme de l'Operating System :** Ancrage dans l'Eïdos, matrice d'émancipation personnelle, signature numérique unique, autorité d'accès système.
